...
ggsave("pd_death_enr_sma.png", akm_trt_fit$plot, width = 6, height = 4, dpi = 1200, device = "png") 
#coma
...
surv_pvalue(km_trt_fit)
ggsave("pd_death_enr_cm.png", km_trt_fit$plot, width = 6, height = 4, dpi = 1200, device = "png") 
#acidotic
...
ggsave("pd_death_acidotic.png", km_trt_fit$plot, width = 6, height = 4, dpi = 1200, device = "png") 
#intestinal injury
...
ggsave("pd_death_tff3_inj.png", km_trt_fit$plot, width = 6, height = 4, dpi = 1200, device = "png") 
#uric_acid
...
ggsave("pd_death_hyper_uri.png", km_trt_fit$plot, width = 6, height = 4, dpi = 1200, device = "png") 
#lacidosis
...
ggsave("pd_death_lacidosis.png",km_trt_fit$plot, width = 6, height = 4, dpi = 1200, device = "png") 
#haki
...
ggsave("pd_death_haki.png", km_trt_fit$plot, width = 6, height = 4, dpi = 1200, device = "png") 
#sex
...
ggsave("pd_death_sex.png", km_trt_fit$plot, width = 6, height = 4, dpi = 1200, device = "png") 
#site
...
ggsave("pd_death_site.png", km_trt_fit$plot, width = 6, height = 4, dpi = 1200, device = "png") 
#Enterob
plot_data <- asv_sick %>%
  tax_fix() %>%
  tax_transform("compositional", rank = "Family") %>%
